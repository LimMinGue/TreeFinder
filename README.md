...
**내용 기반 텍스트 미리보기** — 확장자가 아니라 내용으로 판정: `.gitignore`·`LICENSE`처럼 시스템이 못 여는 파일도 일반 텍스트면 그대로 보여줍니다(확대/축소 포함).

<img src="docs/screenshots/text-preview.png" alt="내용 기반 텍스트 미리보기" width="720">

**내장 터미널 + 파일 드롭** — 미리보기 자리에서 탭 전환. 파일 목록에서 파일을 끌어다 놓으면 이스케이프된 전체 경로가 입력됩니다(프롬프트 끝 참조).

<img src="docs/screenshots/terminal-drop.png" alt="내장 터미널 파일 드롭" width="720">
